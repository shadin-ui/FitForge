      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 font-montserrat max-w-2xl mx-auto">
            Have questions about FitForge? We're here to help you on your fitness journey.
          </p>
        </motion.div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-6 font-montserrat">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-600">support@fitforge.com</span>
                </div>
                <div className="flex items-center space-x-4">
                  <svg className="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-600">123 Fitness Street, Health Valley, CA 94123</span>
                </div>
                <div className="flex items-center space-x-4">
                  <svg className="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  {['twitter', 'facebook', 'instagram', 'linkedin'].map((social) => (
                    <a
                      key={social}
                      href={`https://${social}.com/fitforge`}
